...
namespace Estoque.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public ProdutoController(IEstoqueRepository repo)
        {
            _repo = repo;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Preco,Quantidade,Descricao,FornecedorId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Preco,Quantidade,Descricao,FornecedorId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
